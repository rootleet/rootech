...
<body class="index-page">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5CKN4NCM" height="0" width="0"
  ...
  <main class="main">
              ...
              <div class="product-mockup">
                ...
                <div class="floating-card card-1" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">Increased Revenue Growth</div>
                  </div>
                </div>
                <div class="floating-card card-2" data-aos="fade-up" data-aos-delay="500">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">Increased Productivity</div>
                  </div>
                </div>
                <div class="floating-card card-3" data-aos="fade-up" data-aos-delay="600">
                  ...
                  <div class="card-content">
                    ...
                    <div class="card-label">Enhanced Operations Efficiency</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="content-wrapper">
              ...
              <p class="lead">We harness the latest technology to create innovative digital products that optimize
                workflows, automate processes, and drive business transformation. Our solutions empower teams to
                collaborate efficiently and turn ideas into results quickly in the digital era.</p>
              ...
              <div class="features-row">
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    <h4>Fast Delivery</h4>
                    <p>We deliver solutions that are not only functional but also scalable and adaptable to your
                ...
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    ...
                    <p>Our solutions are built with the highest standards of quality and performance, ensuring long-term
                      reliability and sustained business growth.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="image-stack">
              ...
              <div class="floating-badge">
                ...
                <div class="badge-text">
                  <div class="badge-title">Simplicity First</div>
                  <div class="badge-subtitle">Built on Responsibility</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="services" class="services section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="section-intro">
          <div class="row align-items-center">
            <div class="col-lg-7">
              <h3 class="intro-title">Comprehensive Digital Solutions</h3>
              <p class="intro-text">We deliver end-to-end digital services that drive growth, enhance user experience,
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
            <div class="service-item">
              ...
              <h3>Software Development & Consultancy</h3>
              <p>Deliver robust, scalable, and innovative software tailored to your business needs by leveraging modern
                development tools and industry standards.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Custom Application Development</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item">
              ...
              <h3>Retail Software & Consultancy</h3>
              <p>Empower your retail business with robust software solutions for inventory management, sales tracking,
                and seamless customer experiences.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Point of Sale (POS) Systems</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
            <div class="service-item">
              ...
              <p>Enhance your workforce's skills and productivity with tailored training solutions that empower teams
                and drive organizational growth.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Customized Training Programs</li>
    ...
    <section id="ventures" class="services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Our Ventures</h2>
        <!-- <div><span>Our</span> <span class="description-title">Ventures</span></div> -->
      </div><!-- End Section Title -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="section-intro">
          <div class="row align-items-center">
            <div class="col-lg-7">
              <h3 class="intro-title">Our Flagship Products</h3>
              <p class="intro-text">Explore the ready-to-deploy software solutions engineered by Rootech to streamline
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item">
              <div class="service-header">
                ...
                <span class="badge-popular">Top Seller</span>
              </div>
              <h3>Venta POS</h3>
              <p>A robust, offline-first retail billing system designed to keep your shop running 24/7, even during
                internet or power outages.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> 100% Offline Functionality</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item">
              ...
              <h3>VentaHub</h3>
              <p>Manage your entire business from anywhere in the world with real-time analytics, sales trends, and
                remote inventory management.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Live Sales Monitoring</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item">
              ...
              <h3>VenGo</h3>
              <p>Bridge the gap between your shop and your customers with an automated digital catalog and
                WhatsApp-integrated ordering.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Digital Menu & Catalog</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item">
              ...
              <h3>Beneficious</h3>
              <p>Increase customer lifetime value with a powerful points-based rewards program that keeps shoppers
                coming back to your brand.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Customer Points System</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item">
              <div class="service-header">
                ...
                <span class="badge-popular" style="background: #6c757d;">In Development</span>
              </div>
              <h3>Venta IMS</h3>
              <p>A high-performance Inventory Management System designed for large-scale warehouses and complex
                distribution chains.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> Bulk Stock Movements</li>
                <li><i class="bi bi-check-circle"></i> Expiry & Batch Tracking</li>
                <li><i class="bi bi-check-circle"></i> Supplier Management</li>
              </ul>
              <a href="#" class="service-cta disabled" style="opacity: 0.6; cursor: not-allowed;">
                <span>Coming Soon (40%)</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item">
              <div class="service-header">
                ...
                <span class="badge-popular" style="background: #007bff;">Enterprise</span>
              </div>
              <h3>OCEAN ERP</h3>
              <p>The ultimate Organization OS. A unified ERP ecosystem designed to manage every facet of a modern
                enterprise from one secure platform.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> <strong>Dolphin:</strong> Secure File Cloud</li>
                <li><i class="bi bi-check-circle"></i> <strong>AMC:</strong> Asset & Logistics Control</li>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="700">
            <div class="service-item">
              ...
              <p>Seamless biometric integration. Automate your payroll and track staff attendance
                with hardware-to-cloud synchronization.</p>
              <ul class="feature-list">
                <li><i class="bi bi-check-circle"></i> BioData Integration</li>
    ...
    <section id="blog" class="blog section light-background">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Blog</h2>
        <div><span>Latest</span> <span class="description-title">Insights</span></div>
      </div><!-- End Section Title -->

      <div class="container" data-aos="fade-up" data-aos-delay="100">

        <div class="row gy-4" id="blog_display_section">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="blog-card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Explore how emerging technologies are reshaping retail landscapes across the continent, from AI-powered inventory to mobile payment solutions.</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="blog-card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Essential cybersecurity practices for small and medium enterprises to protect sensitive information from modern threats.</p>
                <div class="author-info">
                  <img src="https://via.placeholder.com/40x40?text=B" alt="Author" class="author-avatar">
                  <div class="author-details">
                    <span class="author-name">Bella Chen</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="blog-card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">Best practices for developing web applications that can handle growth, from architecture design to performance optimization.</p>
                <div class="author-info">
                  <img src="https://via.placeholder.com/40x40?text=C" alt="Author" class="author-avatar">
                  <div class="author-details">
                    <span class="author-name">Carlos Rodriguez</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="blog-card">
              <div class="card-img">
                <img src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="The Rise of AI in Business Operations" class="img-fluid">
              </div>
              <div class="card-body">
                <h5 class="card-title">The Rise of AI in Business Operations</h5>
                <p class="card-text">How artificial intelligence is transforming business processes, from automation to predictive analytics and decision-making.</p>
                <div class="author-info">
                  <img src="https://via.placeholder.com/40x40?text=D" alt="Author" class="author-avatar">
                  <div class="author-details">
                    <span class="author-name">Diana Patel</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="blog-card">
              <div class="card-img">
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="ERP Systems: Transforming Enterprise Management" class="img-fluid">
              </div>
              <div class="card-body">
                <h5 class="card-title">ERP Systems: Transforming Enterprise Management</h5>
                <p class="card-text">Understanding how Enterprise Resource Planning systems integrate business processes for improved efficiency and decision-making.</p>
                <div class="author-info">
                  <img src="https://via.placeholder.com/40x40?text=E" alt="Author" class="author-avatar">
                  <div class="author-details">
                    <span class="author-name">Ethan Lee</span>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="blog-card">
              <div class="card-img">
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Digital Marketing Strategies for 2024" class="img-fluid">
              </div>
              <div class="card-body">
                <h5 class="card-title">Digital Marketing Strategies for 2024</h5>
                <p class="card-text">Effective digital marketing tactics to boost online presence, engage customers, and drive conversions in the current landscape.</p>
                <div class="author-info">
                  <img src="https://via.placeholder.com/40x40?text=F" alt="Author" class="author-avatar">
                  <div class="author-details">
                    <span class="author-name">Fiona Green</span>
        ...
        <div class="row align-items-center mb-5">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="intro-content">
              ...
              <div class="stats-grid">
                <div class="stat-item">
                  <div class="stat-number" data-purecounter-start="0" data-purecounter-end="150"
                    data-purecounter-duration="2">6</div>
                  <div class="stat-label">Projects Delivered</div>
                </div>
                <div class="stat-item">
                  <div class="stat-number" data-purecounter-start="0" data-purecounter-end="98"
                    data-purecounter-duration="2">98</div>
                  <div class="stat-label">% Client Retention</div>
                </div>
                <div class="stat-item">
                  <div class="stat-number" data-purecounter-start="0" data-purecounter-end="250"
                    data-purecounter-duration="2">250</div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="showcase-image">
              <img src="assets/img/illustration-18.webp" alt="Digital Solutions" class="img-fluid">
            </div>
          </div>
        </div>
        ...
        <div class="row g-4 mb-5">
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="value-card">
              ...
              <p>We deliver solutions that are not only functional but also scalable and adaptable to your evolving
                business needs.</p>
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="value-card">
              ...
              <p>We have a team of experienced professionals who are experts in their respective fields and are
                dedicated to delivering the best possible solutions for your business.</p>
              <a href="#" class="learn-more">Learn more <i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2" data-aos="fade-left" data-aos-delay="200">
            <div class="capabilities-content">
              ...
              <p>Our core capabilities span strategic consulting, tailored software development, and long-term support,
                empowering businesses to achieve growth and operational excellence through innovative digital solutions.
              </p>
              ...
              <div class="capability-list">
                <div class="capability-item">
                  ...
                  <p>Our consulting services provide expert guidance, tailored strategies, and actionable insights to
                    help businesses navigate complex challenges and drive growth.</p>
                </div>
                ...
                <div class="capability-item">
                  ...
                  <p>Our development solutions are built on a foundation of scalability, security, and performance,
                    ensuring that businesses can rely on their digital systems to drive growth and success.</p>
                </div>
                ...
                <div class="capability-item">
                  ...
                  <p>Our support services are designed to ensure that businesses can focus on their core operations
                    while we handle the maintenance and optimization of their digital systems.</p>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <!-- <img src="https://via.placeholder.com/80?text=Photo" class="profile-img"
                        alt="Alice - Lisadel Travel and Tour CEO"> -->
                      <div class="profile-info">
                        <h3>Alice</h3>
                        <span>CEO, Lisadel Travel and Tour</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <!-- <img src="https://via.placeholder.com/400?text=Photo" class="featured-img"
                        alt="Alice - Lisadel Travel and Tour CEO"> -->
                    </div>
                  </div>
                </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6">
            <div class="contact-intro">
              ...
              <p>We are ready to help you transform your digital presence and achieve your business goals. Contact us
                today to learn more about our services and how we can help you.</p>
            </div>
            ...
            <div class="contact-channels">
              <div class="channel-card">
                ...
                <div class="channel-info">
                  <h5>Email</h5>
                  <p><a href="mailto:info@rootechits.com">rootech.inc@proton.me</a></p>
              ...
              <div class="channel-card">
                ...
                <div class="channel-info">
                  <h5>Phone</h5>
                  <p>+233 54 631 0011</p>
                  <span class="channel-meta">Mon-Fri, 9AM-6PM GMT</span>
                </div>
              </div>
            ...
            <div class="trust-indicators">
              ...
              <div class="indicator-item">
                <div class="indicator-value">5/5</div>
            ...
            <div class="form-wrapper">
              ...
              <form action="" method="post" class="php-email-form">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ubject" id="Subject" class="form-control" required="">
                </div>
